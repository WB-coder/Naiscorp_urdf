...
def generate_launch_description():
    ...
    bridge_cmd_slide_mid = Node(
        package='ros_gz_bridge',
        executable='parameter_bridge',
        arguments=['/slide_mid_controller/cmd_pos@trajectory_msgs/msg/JointTrajectory]ignition.msgs.JointTrajectory'],
        output='screen'
    )

    bridge_cmd_slide_up = Node(
        package='ros_gz_bridge',
        executable='parameter_bridge',
        arguments=['/slide_up_controller/cmd_pos@trajectory_msgs/msg/JointTrajectory]ignition.msgs.JointTrajectory'],
        output='screen'
    )
